...
const ProfileUpdateForm = ({ initialData, onSubmit, onCancel }) => {
  ...
  const inputClass = cx(
    "pl-10 w-full p-2 border rounded-lg",
    isDark
  ...
  const labelClass = cx("block text-sm font-medium mb-2", isDark ? "text-gray-200" : "text-gray-700")

  const sectionHeaderClass = cx("text-lg font-semibold mb-4", colors.text)

  const formSectionClass = cx(
    "mb-8 p-6 rounded-lg",
  ...
  const cardClass = cx(
    "p-4 mb-3 rounded-lg flex flex-col",
  ...
  const iconButtonClass = cx(
    ...
    isDark ? "hover:bg-gray-600 text-gray-300 hover:text-white" : "hover:bg-gray-100 text-gray-500 hover:text-gray-700",
  )
      ...
      <div className="mb-8">
        ...
        <div className={formSectionClass}>
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Describe your professional background and objectives..."
            />
          </div>
        </div>
        ...
        <div className={formSectionClass}>
          ...
          <div className="mb-6 p-4 rounded-lg border">
            ...
            <div className="flex justify-end">
              <button type="button" onClick={addEducation} className={buttonPrimary}>
                ...
                <div key={index} className={cardClass}>
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex space-x-2">
                      <button type="button" onClick={() => editEducation(index)} className={iconButtonClass}>
                        <Pencil size={16} />
                      </button>
                      <button type="button" onClick={() => removeEducation(index)} className={iconButtonClass}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
                  ...
                  {edu.yearOfCompletion && (
                    <div className={cx("text-sm", colors.textMuted)}>Graduated: {edu.yearOfCompletion}</div>
                  )}
                </div>
              ))}
          </div>
        ...
        <div className={formSectionClass}>
          ...
          <div className="mb-6 p-4 rounded-lg border">
            ...
            <div className="flex justify-end">
              <button type="button" onClick={addExperience} className={buttonPrimary}>
          ...
          <div className="space-y-3">
            {formData.experience &&
              formData.experience.map((exp, index) => (
                <div key={index} className={cardClass}>
                  <div className="flex justify-between items-start mb-2">
                    <div className={cx("font-semibold", colors.text)}>{exp.position}</div>
                    <div className="flex space-x-2">
                      <button type="button" onClick={() => editExperience(index)} className={iconButtonClass}>
                        <Pencil size={16} />
                      </button>
                      <button type="button" onClick={() => removeExperience(index)} className={iconButtonClass}>
                        <Trash2 size={16} />
                      </button>
                    </div>
                  </div>
                  ...
                  {exp.description && <div className={cx("mt-2 text-sm", colors.textSecondary)}>{exp.description}</div>}
                </div>
              ))}
          </div>
        </div>
        ...
        <div className={formSectionClass}>
          ...
          <div className="flex gap-2 mb-4">
            <input
              ...
              className={inputClass.replace("pl-10", "pl-3")}
            />
            <button type="button" onClick={() => addItem("skills", newSkill, setNewSkill)} className={buttonPrimary}>
              <Plus size={24} />
            </button>
          </div>
            ...
            {formData.skills &&
              formData.skills.map((skill, index) => (
                <span key={index} className={tagClass}>
                  {skill}
                  <button type="button" onClick={() => removeItem("skills", index)} className="hover:text-red-500">
                    <X size={16} />
                  </button>
                </span>
              ))}
          ...
          <div className="flex flex-wrap gap-2">
            {formData.languages &&
              formData.languages.map((language, index) => (
                <span key={index} className={tagClass}>
                  {language}
                  <button type="button" onClick={() => removeItem("languages", index)} className="hover:text-red-500">
                    <X size={16} />
                  </button>
                </span>
              ))}
