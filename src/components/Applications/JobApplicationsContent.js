  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch job details
        const jobResponse = await fetch(`https://test.airuter.com/api/jobs/${jobId}`, {
          headers: {
        ...
        const applicationsResponse = await fetch(`https://test.airuter.com/api/applications/job/${jobId}`, {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
